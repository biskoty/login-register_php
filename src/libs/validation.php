...
const DEFAULT_VALIDATION_ERRORS = [
    ...
    'email' => "Le %s n'est pas une adresee email valide",
    'min' =>  'Le %s doit comporter au moins %s',
    'max' => 'Le %s doit avoir au plus les caractères %s',
    'between' => 'Le %s doit avoir au plus %s caractères',
    'same' => 'Le %s doit correspondre à %s',
    'alphanumeric' => 'Le %s ne doit contenir que des lettres et des chiffres',
    'secure' => 'Le %s doit comporter entre 8 et 64 caractères et contenir au moins un chiffre, une lettre majuscule, une lettre minuscule et un caractère spécial.',
